...
module.exports = function(e, d) {
    ...
    for (b.last = function() {
        ...
        if (u = !0, b.last() && c[b.last()]) e = e.replace(new RegExp("([\\s\\S]*?)</" + b.last() + "[^>]*>"), function(e, t) {
            ...
            "";
        }), f(0, b.last()); else if (0 == e.indexOf("\x3c!--") ? (h = e.indexOf("--\x3e")) >= 0 && (d.comment && d.comment(e.substring(4, h)), 
        e = e.substring(h + 3), u = !1) : 0 == e.indexOf("</") ? (p = e.match(r)) && (e = e.substring(p[0].length), 
        p[0].replace(r, f), u = !1) : 0 == e.indexOf("<") && (p = e.match(t)) && (e = e.substring(p[0].length), 
        p[0].replace(t, function(e, t, r, c) {
            ...
            g += h < 0 ? e : e.substring(0, h), e = h < 0 ? "" : e.substring(h), d.chars && d.chars(g);
        }
