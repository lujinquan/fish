...
Page({
   ...
   */
  calcAmount: function() {
    let { is_open_vipcard_buy, is_vip_card_member, carts, delivery_tuanz_money, man_free_tuanzshipping, vipcard_save_money, canLevelBuy, level_save_money } = this.data;
