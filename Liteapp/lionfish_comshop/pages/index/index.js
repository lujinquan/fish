...
Page(Object.assign({}, countDownInit.default, {
  ...
  fliterCommunity: function (community){
    ...
    let newCommunity = Object.assign({}, community, { address: resArr[1] || resArr[0] });
    return newCommunity;
  },
    ...
    app.util.request({
      ...
      success: function(res) {
        ...
        if (rdata.code == 0) {
          ...
          //秒杀
          let { scekill_time_arr, seckill_bg_color, seckill_is_open, seckill_is_show_index, hide_community_change_word } = rdata;
          let myDate = new Date();
