									...
									<div class='layui-input-block'>
										<div class="radio-inline">
											...
											<div class="layui-input-inline">
												<input type="text" name="parameter[delivery_ziti_name]" value="<?php echo ($data['delivery_ziti_name']); ?>" class="layui-input" />
											</div>
								...
								<div class="layui-form-item">
									...
									<div class='layui-input-block'>
										<div class="radio-inline">
											<div class="layui-form-mid layui-word-aux">名称</div>
											<div class="layui-input-inline">
												<input type="text" name="parameter[delivery_tuanzshipping_name]" value="<?php echo ($data['delivery_tuanzshipping_name']); ?>" class="layui-input" />
											</div>
								...
								<div class="layui-form-item">
									...
									<div class='layui-input-block'>
										<div class="radio-inline">
											...
											<div class="layui-input-inline">
												<input type="text" name="parameter[placeorder_tuan_name]" value="<?php echo ($data['placeorder_tuan_name']); ?>" class="layui-input" />
											</div>
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										...
										<div class="radio-inline" id="free_tuanz_free" <?php if( isset($data['delivery_type_tuanz']) && $data['delivery_type_tuanz'] ==1 ){ ?> display: inline-block;<?php }else{ ?> display: none;<?php } ?>>
											...
											<div class="layui-form-mid layui-word-aux">免团长配送费（0则不减免运费）</div>
										</div>
									</div>
								</div>
							</li>
								...
								<div class="layui-form-item">
									...
									<div class='layui-input-block'>
										<div class="radio-inline">
											<div class="layui-form-mid layui-word-aux">名称</div>
											<div class="layui-input-inline">
												<input type="text" name="parameter[delivery_express_name]" value="<?php echo ($data['delivery_express_name']); ?>" class="layui-input" />
											</div>
								...
								<div class="layui-form-item">
									...
									<div class='layui-input-block'>
										<div class="radio-inline">
											...
											<div class="layui-input-inline">
												<input type="text" name="parameter[placeorder_trans_name]" value="<?php echo ($data['placeorder_trans_name']); ?>" class="layui-input" />
											</div>
								...
								<div class="layui-form-item">
									...
									<div class='layui-input-block'>
										<div class="radio-inline" id="man_free_shipping" <?php if( isset($data['delivery_type_express']) && $data['delivery_type_express'] ==1 ){ ?> <?php }else{ ?> style="display:none;" <?php } ?> >
											...
											<div class="layui-form-mid layui-word-aux">免配送费（0则不减免运费）</div>
										</div>
									</div>
								</div>
							</li>
