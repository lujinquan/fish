...
<div class="layui-fluid">
	<div class="layui-card">
		<div class="layui-card-header layui-elem-quote">当前位置：
			<span class="line-text"><?php if( !empty($item['id'])){ ?>编辑<?php  }else{ ?>添加<?php } ?>商品规格 <small><?php if( !empty($item['id'])){ ?>修改【<?php echo ($item['name']); ?>】<?php } ?></small></span></div>
			...
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="data[name]" class="form-control" value="<?php echo ($item['name']); ?>" data-rule-required="true" />
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<table class="table table-responsive" style="margin:0;">
							...
							<?php foreach( $labelname as $row ){ ?>
							<tr>
								<td>
									<input type="text" class="form-control" name="data[value][]" value="<?php echo ($row); ?>" >
								</td>
								<td style="width: 45px;">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="btn btn-default" style='margin-left:10px;' href="<?php echo U('goods/goodsspec',array('ok'=>'1'));?>">返回列表</a>
