		...
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
				...
				<li class="layui-nav-item" lay-unselect id="new_msg" style="display:none;">
					<a lay-href="<?php echo U('system/auth_upgrade');?>" id="update_urlevent" layadmin-event="message" lay-text="点击升级" >
				...
				<li class="layui-nav-item layui-hide-xs lay-logins" lay-unselect>
					<a href="javascript:;">
						...
						<?php  if( $_W['role'] == 'agenter' ) { $supper_info = json_decode(base64_decode($_GPC['__lionfish_comshop_agent']), true); echo $supper_info['shopname']; }else{ echo D('Home/Front')->get_config_by_name('shoname'); } ?>
