				...
				<div class="layui-form-item">
				  <div class="layui-inline">
					...
					<div class="layui-input-inline" style="width: 260px;">
						...
						<button type="button" data-confirm="确认批批量确认付款吗？" data-href="<?php echo U('order/oppay_all',array('order_status'=>3));?>" name="batchprocess" value="1" class="layui-btn layui-btn-sm batchprocess">批量确认付款</button>
