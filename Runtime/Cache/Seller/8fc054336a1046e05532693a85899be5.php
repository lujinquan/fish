                ...
                <div class="page-toolbar">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-btn-group">
    						...
    						<button data-export="2" type="submit" class="layui-btn layui-btn-sm btn-submit layui-btn-primary">导出配送总单</button>
						...
						<div class="page-table-header">
							...
							<div class="btn-group">	 
                               ...
                               <span class="pull-right">
									<a  class='btn layui-btn  layui-btn-sm' id="delivery_allprint" href="javascript:;" data-target="_blank" data-href="<?php echo U('delivery/delivery_allprint');?>" >
									...
									<a  class='btn layui-btn  layui-btn-sm' id="delivery_allprint_order" data-target="_blank" data-href="<?php echo U('delivery/delivery_allprint_order');?>" >
										<span data-toggle="tooltip" data-placement="top" title="" data-original-title="一键打印所有团长相关订单">
											一键打印所有团长相关订单
										</span>
									</a>
            				  </span>
...
layui.use(['jquery', 'layer','form'], function(){ 
	...
	$('#delivery_allprint,#delivery_allprint_order').click(function(){
