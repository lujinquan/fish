	...
	<div class="layui-card">
		...
		<div class="layui-card-body" style="padding:15px;">
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item">
					<label class="layui-form-label">首页团长信息字体颜色</label>
					<div class="layui-input-block">
						<div class="" style="margin:0px;">
							<div class="layui-input-inline" style="width: 120px;">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">禁止切换小区</label>
					<div class="layui-input-block">
						<input type="radio" name="parameter[hide_community_change_btn]" value="1" title="禁止" <?php if( !empty($data) && $data['hide_community_change_btn'] ==1 ){ ?>checked <?php } ?> />
					  	...
					  	<br>
				  		<span class='layui-form-mid'>备注：用户无论点击哪个团长分享出来的链接，都是直接进入绑定原小区，无提示。</span>
					</div>
				</div>
