...
<div class="layui-fluid">
    ...
    <span>&nbsp;&nbsp;&nbsp;&nbsp;订单数:  <span class='text-danger'><?php echo ($total); ?></span> 
	</span></span>
	</div>
                            ...
                            <tbody>
                                    ...
                                    <td colspan="10">
                                        <div class="tDiv ml10">
											...
											<div style='text-align:right;font-size:12px;display:inline-block;' >
												...
												<a href="javascript:;"  data-confirm="确认立即退款吗？" class="deldom" data-href="<?php echo U('order/oprefund_do',array('id'=>$item['order_id']));?>">
												  &nbsp;&nbsp;立即退款
												</a>&nbsp;&nbsp;
												<?php } ?>
                                ...
                                <tr class="">
                                    ...
                                    <td class="td-price" style="vertical-align: top;">
										<?php $i =1; foreach($item['goods'] as $k => $g){ ?>		
										<div class="tDiv tpinfo <?php if($i == count($item['goods'])){ ?>last<?php } ?>" style="display: flex;align-items: center;">积分<?php echo round($g['total']/$g['quantity'],2); ?> 
                                    ...
                                    <td>
                                    	<div class="tDiv" style="">
											...
											应收总款：<?php if( $item['shipping_fare'] >0 ){ ?>￥<?php echo round( $item['shipping_fare'] ,2);?>+<?php } echo round($item['total'] ,2);?>积分
											</span>
                                        </div>    
                                    </td>
                                    <td>
								...
								<tr>
									<td colspan="7"><div style='background:#fdeeee;color:red;'>买家备注: <?php echo ($item['comment']); ?></div></td>
								</tr>
								<?php } ?>
								 <tr>
									<td colspan="7">
