			...
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
						...
						<label class='radio-inline'>
							<input type='radio' name='parameter[is_open_pintuan_orderprint]' value='1' <?php if( !empty($data) && $data['is_open_pintuan_orderprint'] ==1 ){ ?>checked <?php } ?> title="显示" /> 
						</label>
						<span class="help-block"> 
				...
				<div class="layui-form-item" style="display:none;">
                    ...
                    <div class="layui-input-block">
						...
						<span class="help-block"> 
							左右布局为每行俩个商品，商品居多建议左右布局，横向布局为每行一个商品
						</span> 
                    </div>
                </div>
				...
				<div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
						<label class='radio-inline'>
							<input type='radio' name='parameter[pintuan_index_show]' value='0' <?php if( empty($data) || $data['pintuan_index_show'] ==0 ){ ?>checked <?php } ?> title="不显示" /> 
						</label>
						<label class='radio-inline'>
							<input type='radio' name='parameter[pintuan_index_show]' value='1' <?php if( !empty($data) && $data['pintuan_index_show'] ==1 ){ ?>checked <?php } ?> title="显示" /> 
						</label> 
						<span class="help-block"> 
							备注：首页“新人专享”“限时秒杀”之间显示“封面图+拼团商品” 当设置不显示，就没有下面这个设置
						</span> 
                    </div>
                </div>
				...
				<div class="layui-form-item" >
                    ...
                    <div class="layui-input-block">
						<label class='radio-inline'>
							<input type='radio' name='parameter[pintuan_model_buy]' value='0' <?php if( empty($data) || $data['pintuan_model_buy'] ==0 ){ ?>checked <?php } ?> title="仅快递" /> 
						</label>
						<label class='radio-inline'>
							<input type='radio' name='parameter[pintuan_model_buy]' value='1' <?php if( !empty($data) && $data['pintuan_model_buy'] ==1 ){ ?>checked <?php } ?> title="关联团长" /> 
						</label> 
						<span class="help-block"> 
							备注：<br/> 
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                    	<label class='radio-inline'>
							<input type='radio' name='parameter[pintuan_close_stranger]' value='1' <?php if( !empty($data) && $data['pintuan_close_stranger']==1 ){ ?>checked <?php } ?> title="隐藏" />
						</label> 
						<label class='radio-inline'>
							<input type='radio' name='parameter[pintuan_close_stranger]' value='0' <?php if( empty($data) || $data['pintuan_close_stranger']==0 ){ ?>checked <?php } ?> title="显示" />
						</label>
                    </div>
                </div>
