...
<table class="table supplyquery table-hover supplyquery" style="min-width:850px;">
	...
	<tfoot>
		<tr>
			<td colspan='4' align='center' id="pager_ajax"><?php echo ($pager); ?></td>
		</tr>
	</tfoot>
	<?php } ?>
</table>
...
var query_url = "<?php echo U($url, array('is_not_hexiao' => $is_not_hexiao));?>";
<?php  }else{ ?>
var query_url = "<?php echo U('user/zhenquery', array('is_not_hexiao' => $is_not_hexiao));?>";
<?php } ?>
var can_next = true;
