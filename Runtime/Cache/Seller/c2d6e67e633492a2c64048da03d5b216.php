			...
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item" >
					...
					<div class="layui-input-block" >
						<?php echo tpl_form_field_image2('parameter[seller_backimage]', $data['seller_backimage']);?>  <span class='layui-form-mid'>商家后台登录页面，封面图（400*300），（XXX|管理后台）也是这个图片。手动FTP替换地址：Common/image/pdd_small2.png</span>
					</div>
				</div>
				...
				<div class="layui-form-item" >
					...
					<div class="layui-input-block">
						<?php echo tpl_form_field_image2('parameter[admin_login_image]', $data['admin_login_image']);?> <span class='layui-form-mid'>尺寸：250*32</span>
					</div>
				</div>
				...
				<div class="layui-form-item" >
					...
					<div class="layui-input-block">
						<?php echo tpl_form_field_image2('parameter[goods_details_price_bg]', $data['goods_details_price_bg']);?>
				...
				<div class="layui-form-item" >
					...
					<div class="layui-input-block">
						<?php echo tpl_form_field_image2('parameter[index_share_qrcode_bg]', $data['index_share_qrcode_bg']);?>
				...
				<div class="layui-form-item" style="">
					...
					<div class="layui-input-block">
						<?php echo tpl_form_field_image2('parameter[index_bottom_image]', $data['index_bottom_image']);?>
				...
				<div class="layui-form-item" style="">
					...
					<div class="layui-input-block">
						<?php echo tpl_form_field_image2('parameter[index_list_top_image]', $data['index_list_top_image']);?>
						<span class='layui-form-mid'>原尺寸：332*88</span>
						<label class="layui-form-label" style="width: auto;padding-left: 0;">关闭默认</label>
						<div class="layui-input-block">
							<label class='radio-inline'>
								<input type='radio' name='parameter[index_list_top_image_on]' title="否" value='0' <?php if( !empty($data) && $data['index_list_top_image_on'] ==0 ){ ?>checked <?php } ?> />
							</label>
							<label class='radio-inline'>
								<input type='radio' name='parameter[index_list_top_image_on]' title="是" value='1' <?php if( empty($data) || $data['index_list_top_image_on'] ==1 ){ ?>checked <?php } ?> /> 
							</label>
						</div>
					</div>
				</div>
				<div class="layui-form-item" style="">
					...
					<div class="layui-input-block">
						<?php echo tpl_form_field_image2('parameter[goods_details_middle_image]', $data['goods_details_middle_image']);?>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<?php echo tpl_form_field_image2('parameter[common_header_backgroundimage]', $data['common_header_backgroundimage']);?>
						<span class='layui-form-mid'>尺寸：750*340</span>
					</div>
				</div>

				<div class="layui-form-item">
					<label class="layui-form-label">授权登录背景</label>
					<div class="layui-input-block">
						<?php echo tpl_form_field_image2('parameter[auth_bg_image]', $data['auth_bg_image']);?>
						<span class='layui-form-mid'>建议尺寸：750*1500</span>
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<?php echo tpl_form_field_image2('parameter[newauth_bg_image]', $data['newauth_bg_image']);?>
				...
				<div class="layui-form-item" >
					...
					<div class="layui-input-block" style="padding-top:7px;">
						<a id="clear_qrcode" href="javascript:;"  data-href="<?php echo U('config/clearqrcode');?>"  class="text-primary"  target="_balnk">立即更新</a>
					</div>
				</div>
				<div class="layui-form-item">
