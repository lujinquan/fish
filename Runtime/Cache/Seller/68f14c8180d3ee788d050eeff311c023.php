			...
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				<table class="table table-responsive layui-table" lay-even lay-skin="line" lay-size="lg">
					...
					<tbody>
						...
						<tr>
							<td>团长申请页</td>
							<td>/lionfish_comshop/pages/groupCenter/apply</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>供应商申请页</td>
						...
						<tr>
							<td>团长中心</td>
							<td>/lionfish_comshop/pages/groupCenter/index</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>团长中心-我的团单</td>
							<td>/lionfish_comshop/pages/groupCenter/groupList</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>团长中心-社区用户</td>
							<td>/lionfish_comshop/pages/groupCenter/communityMembers</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>团长中心-结算记录</td>
							<td>/lionfish_comshop/pages/groupCenter/distributionList</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>团长中心-我的钱包</td>
							<td>/lionfish_comshop/pages/groupCenter/wallet</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>团长中心-提现申请</td>
							<td>/lionfish_comshop/pages/groupCenter/editInfo</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>团长中心-核销管理</td>
						...
						<tr>
							<td>团长中心-团长分销</td>
							<td>/lionfish_comshop/pages/groupCenter/gruopInfo</td>
							<td>&nbsp;</td>
						</tr>
