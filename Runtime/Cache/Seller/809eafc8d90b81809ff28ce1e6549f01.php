			...
			<div class="summary_box">
				<div class="summary_title">
					<div class="title_inner">
						已提现金额：<?php echo ($supply_commiss['getmoney']); ?>&nbsp;&nbsp;提现中金额：<?php echo $supply_commiss['dongmoney']<0 ?0:$supply_commiss['dongmoney'];?>&nbsp;&nbsp;可提现金额：<span class="text-danger"><?php echo ($supply_commiss['money']); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="<?php echo U('supply/apply_money');?>" class="btn btn-primary">申请提现</a>
					</div>
