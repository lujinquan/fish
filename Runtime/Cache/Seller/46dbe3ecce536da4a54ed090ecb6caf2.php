...
<body layadmin-themealias="default">
    ...
    <div class="layui-fluid">
        <div class="layui-card">
            <div class="layui-card-header layui-elem-quote">当前位置：<span class="line-text"><?php if( !empty($item['id'])){ ?>编辑<?php  }else{ ?>添加<?php } ?>文章<?php if( !empty($item['id'])){ ?>(<?php echo ($item['title']); ?>)<?php } ?></span></div>
                ...
                <form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" id='title' name="data[title]" class="form-control" value="<?php echo ($item['title']); ?>" >
                        </div>
                    </div>
                    <div class="layui-form-item">
                ...
                success: function (info) {
                    ...
                    if(info.status == 0)
                    {
                        ...
                        layer.msg('操作成功',{time: 1000,
								...
								var backurl = "<?php echo U('article/index',array('ok'=>'1'));?>";
