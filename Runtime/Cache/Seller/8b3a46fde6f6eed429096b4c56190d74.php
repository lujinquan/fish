					...
					<div class="layui-input-block">
						<div class="dEdit_1">
							<div class="layui-inline">
								...
								<div class="layui-input-inline" style="width: 100px;">
									<input class="form-control input-sm" data-val="true"   id="lon" name="lon" readonly="readonly" type="text" value="<?php echo ($item['lon']); ?>">
								</div>
								
								<div class="layui-input-inline" style="width: 100px;">
									<input class="form-control input-sm" data-val="true" id="lat" name="lat" readonly="readonly" type="text" value="<?php echo ($item['lat']); ?>">
								</div>
							</div>
