			...
			<form action="" class="layui-form" lay-filter="example" method="post" >
				...
				<div class="layui-row order-container">
					<div class="order-container-left" style="border-right: 1px solid #efefef">
						<div class="layui-row">
							<div class="layui-col-md-12">
								<ul class="">
									<li class="text"><span class="layui-col-sm">订单编号：</span><span class="text-default"><?php echo ($item['order_num_alias']); ?></span></li>
									<?php if( !empty($coupon)){ ?>
									<li class="text">
					...
					<div class=" order-container-static">
						<div class=" status">
							...
							<span class="text-success font18">已退款</span>
							<?php } ?>
				...
				<table class="layui-table ">
					...
					<tr class="trorder" style="background: #fff">
						...
						<th style="text-align: center;width: 130px">单价</th>
				...
				overflow: hidden;text-overflow: ellipsis;"><?php echo ($goods['name']); if($goods['is_refund_state'] == 1 ){ ?>(退款)<?php } ?></a>
							...
							<td style="padding: 10px 20px">
								 &nbsp;&nbsp;商品小计<?php echo ($goods['total']); ?><br/>
								 -&nbsp;满减:<?php echo ($goods['fullreduction_money']); ?><br/>
								 -&nbsp;优惠券：<?php echo ($goods['voucher_credit']); ?><br/>
								 =&nbsp;基数<?php echo $goods['total'] -$goods['fullreduction_money']-$goods['voucher_credit']; ?>
							...
							<td style="padding: 10px 20px">
									...
									团长：<?php echo $vvv['head_name']; ?>&nbsp;&nbsp;佣金：
									<?php if($item['delivery']=='tuanz_send'){ ?>
										<?php echo round($vvv['money'] - $vvv['add_shipping_fare'],2); ?> + <?php echo $vvv['add_shipping_fare']; ?>= <?php echo $vvv['money']; ?>
					...
					<tr class="trorder">
						...
						<td  <?php if($item['type'] == 'integral'){ ?> colspan="6"<?php }else{ ?> colspan="7"<?php } ?> style="padding-right: 60px">
							<div class="price">
								...
								<p> <span class="price-inner">商品小计：</span><span style="font-weight: bold"><?php if( $item['type'] == 'integral' ){ }else{ ?>￥<?php } echo round($item['total'],2); if( $item['type'] == 'integral' ){ ?>积分<?php } ?></span></p>
