				...
				<div class="layui-form-item">
				  <div class="layui-inline">
					<div class="layui-input-inline" >
						<input type="text" class="layui-input"  name="keyword" value="<?php echo ($keyword); ?>" placeholder="请输入昵称"/>
						...
						<table class="table table-responsive" lay-even lay-skin="line" lay-size="lg">
							...
							<?php foreach( $list as $row ){ ?>
								<tr>
									...
									<?php if( empty($row['groupname'])){ ?>默认分组<?php  }else{ echo ($row['groupname']); } ?>
									</td>
								   ...
								   <?php if($commiss_level > 0){ ?>
									...
									<td style="overflow:visible;text-align: center;">
										...
										<div class="btn-group">
											...
											<a class="layui-btn layui-btn-xs" href="<?php echo U('order/index', array('type' => 'all','searchfield'=>'member','keyword'=>$row['username']));?>"
											   title=''>
												  会员订单
											</a>
