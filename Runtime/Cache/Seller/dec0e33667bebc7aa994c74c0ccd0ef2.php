...
<div class="layui-fluid">
  <div class="layui-card">
    <div class="layui-card-header layui-elem-quote">当前位置：<span class="line-text">购买会员订单</span></div>
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
			  <div class="layui-input-inline">
				<input type="text" class="layui-input" name='keyword' value="<?php echo ($_GPC['keyword']); ?>" placeholder="输入订单号然后回车">  
			  </div>
			  <div class="layui-input-inline">
            ...
            <table class="layui-table" lay-skin="line" lay-size="lg">
			  ...
			  <?php foreach($list as $item){ ?>
                <tr>
                  ...
                  <td>
                    <?php echo ($item['expire_day']); ?>天有效期
                  </td>
				  <td>
					<?php if( $item['order_type'] == 1 ){ ?>
					首次购买
					<?php }else if($item['order_type'] == 2 ){ ?>
					有效期内续期
					<?php }else if($item['order_type'] == 3){ ?>
					过期后续费
					<?php } ?>
				  </td>
				   <td>
