		...
		<div class="layui-card-body" style="padding:15px;">
			<form action="" class="layui-form" lay-filter="example" method="post" >
				<div class="page-table-header">
                    <div class="btn-group">    
                        <a class='btn btn-default btn-sm btn-op btn-operation'  data-toggle='batch' data-href="<?php echo U('supply/agent_tixian',array('state'=>1));?>"  data-confirm='确认要审核通过，确定已经打款给供应商?'>
                            <i class="icow icow-shenhetongguo"></i>审核通过
                        </a>
                        <a class='btn btn-default btn-sm btn-op btn-operation'  data-toggle='batch' data-href="<?php echo U('supply/agent_tixian',array('state'=>0));?>" data-confirm='确认要取消审核，申请中的金额将退回供应商账户?'>
                        ...
                        <table class="layui-table" lay-skin="line" lay-size="lg">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td > 
                                        <?php echo ($row['supper_info']['shopname']); ?>
                                    </td>
                                    <td>
										...
										<?php if( $row['supply_apply_type'] == 1 ){ ?>
											...
											微信真实姓名：<br/>
												...
												<a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php echo U('supply/changename',array('type'=>'bankaccount','id'=>$row['id']));?>" >
													<text class='text-primary'><?php echo ($row['bankaccount']); ?></text>
												</a>
											<br/>
                                    ...
                                    <td>
										...
										<input type="checkbox" name="" lay-filter="statewsitch" data-href="<?php echo U('supply/agent_tixian',array('state'=>1,'id'=>$row['id']));?>" <?php if( $row['state']==1){ ?>checked<?php  }else{ } ?> lay-skin="switch" lay-text="审核通过?已经打款给供应商|通过?已经打款?">
										
										<input type="checkbox" name="" lay-filter="statewsitchunable" data-href="<?php echo U('supply/agent_tixian',array('state'=>2,'id'=>$row['id']));?>" <?php if( $row['state']==1 ){ ?>checked <?php } ?> lay-skin="switch" lay-text="已经拒绝|点击拒绝审核">
