	...
	<div class="layui-card">
		...
		<div class="layui-tab layui-tab-brief" >
		  <ul class="layui-tab-title">
                <li  <?php if( empty($type) || $type=='mult'){ ?>class="layui-this"<?php } ?> ><a href="<?php echo U('group/ordersendall', array('type' => 'mult','ok' => 1));?>">快递导入方式</a></li>
				<li  <?php if( $type=='mult_member_receive_order'){ ?>class="layui-this"<?php } ?> ><a href="<?php echo U('group/ordersendall', array('type' => 'mult_member_receive_order','ok' => 1));?>">订单批量确认收货</a></li>
