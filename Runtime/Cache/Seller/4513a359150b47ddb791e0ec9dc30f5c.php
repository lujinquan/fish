			...
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<label class="radio-inline"><input lay-ignore type="checkbox" name="data[supply_can_goods_sendscore]" value="1" <?php if( !isset($data['supply_can_goods_sendscore']) || (isset($data['supply_can_goods_sendscore']) && $data['supply_can_goods_sendscore'] ==1 ) ){ ?> checked="checked" <?php } ?> title="" /> 下单送积分</label>
