...
<div class="layui-fluid">
	<div class="layui-card">
		<div class="layui-card-header layui-elem-quote">当前位置：<span class="line-text">会员分组</span></div>
					...
					<div class="col-md-12">
						...
						<div class="page-table-header">
							...
							<span class="pull-right"> 
								<a  href="javascript:;" data-href="<?php echo U('user/addusergroup');?>" class="layui-btn layui-btn-sm ajaxModal"><i class="fa fa-plus"></i> 添加会员分组</a>
								
							</span>
							<div class="btn-group">
								<button class="btn btn-default btn-sm  btn-operation"  type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="<?php echo U('user/deleteusergroup');?>">
									 删除
								</button>
							</div>
						</div>
						<table class="table table-responsive" lay-even lay-skin="line" lay-size="lg">
                            ...
                            <tr <?php if( $row['id']=='default'){ ?>style='background:#eee;'<?php } ?>>
                                ...
                                <td>
									...
									<a class='layui-btn layui-btn-xs' href="<?php echo U('user/index', array('groupid' => $row['id']));?>">
										<span data-toggle="tooltip" data-placement="top" data-original-title="分组会员">
												<i class='icow icow-member'></i>分组会员
											</span>
									</a>
                                    
                                    <?php if( $row['id']!='default'){ ?>
                                       
											<a class="layui-btn layui-btn-xs ajaxModal" href="javascript:;" data-href="<?php echo U('user/addusergroup', array('id' => $row['id']));?>">
												<i class="layui-icon layui-icon-edit"></i>编辑
											</a>
							
											<a  class='layui-btn layui-btn-xs deldom' href="javascript:;" data-href="<?php echo U('user/deleteusergroup', array('id' => $row['id']));?>" data-confirm='确认要删除此分组吗'>
