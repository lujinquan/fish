	...
	<div class="layui-card">
		...
		<div class="layui-card-body" style="padding:15px;">
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item price" id="operate_fullreduction" <?php if( empty($data) || $data['is_open_fullreduction'] ==0 ){ ?>style="display:none;"<?php } ?>>
					<label class="layui-form-label">满</label>
					<div class="layui-input-block" style="width: 300px;">
						<div class="input-group">
							<input type="text" name="parameter[full_money]" class="form-control valid" value="<?php echo ($data['full_money']); ?>" aria-invalid="false">
							<span class="input-group-addon">元 减</span>
							<input type="text" name="parameter[full_reducemoney]" class="form-control" value="<?php echo ($data['full_reducemoney']); ?>">
