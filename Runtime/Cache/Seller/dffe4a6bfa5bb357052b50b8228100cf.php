                        ...
                        <table class="layui-table" lay-skin="line" lay-size="lg">
                            <thead class="navbar-inner">
                                <tr>
                                    ...
                                    <th style="width:200px">申请时间</br>审核时间</th>
									...
									<td>
										<?php if( $row['state'] == 0 ){ ?>
											...
											<?php if( $row['goods_count'] <= 0 ){ ?>
												<a class='op layui-btn layui-btn-xs'  data-toggle="ajaxModal" href="javascript:;" data-href="<?php echo U('supply/agent_check_first', array('id' => $row['id']));?>" >
											...
											<?php }else{ ?>
												<input type="checkbox" name="" lay-filter="statewsitch" data-href="<?php echo U('supply/agent_check', array('id'=>$row['id']));?>" <?php if( $row['state']==1 ){ ?>checked<?php } ?> lay-skin="switch" lay-text="已审核|未审核">
											<?php } ?>
