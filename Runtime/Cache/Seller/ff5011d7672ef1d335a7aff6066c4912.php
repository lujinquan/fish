		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="input-group fixsingle-input-group">
					...
					<label class='radio-inline'><input type='radio' name='data[kucun_method]' value='1' <?php if( $data['kucun_method']=='1'){ ?>checked<?php } ?> title="付款后减库存" /> </label>
		...
		<div class="layui-form-item" id="feier_print" style="<?php if( empty($data['open_feier_print']) || $data['open_feier_print'] ==2 ){ ?>display:none;<?php } ?>">
            ...
            <div class="layui-input-block">
				<div class="input-group fixsingle-input-group">
                    ...
                    <input type="text" name="data[feier_print_lian]" class="form-control" value="<?php echo ($data['feier_print_lian']); ?>" />
            ...
            <div class="layui-input-block">
				...
				<div class="input-group fixsingle-input-group">
                    ...
                    <input type="text" name="data[yilian_msign]" class="form-control" value="<?php echo ($data['yilian_msign']); ?>" />
					 <div class="input-group-addon"><b>打印联数：</b></div>    
                    <input type="text" name="data[yilian_print_lian]" class="form-control" value="<?php echo ($data['yilian_print_lian']); ?>" />
                 </div>    
