...
<div class="layui-fluid">
	<div class="layui-card">
		<div class="layui-card-header layui-elem-quote">当前位置：<span class="line-text">虚拟会员</span></div>
		<div class="layui-card-body" style="padding:15px;">
			<form action="" method="get" class="form-horizontal form-search layui-form" role="form">
				<input type="hidden" name="c" value="user" />
				<input type="hidden" name="a" value="userjia" />
					...
					<div class="col-md-12">
						...
						<div class="page-table-header">
							...
							<span class="pull-right"> 
								<a href="<?php echo U('user/adduserjia', array('ok' => 1));?>" class="layui-btn layui-btn-sm "><i class="fa fa-plus"></i> 添加虚拟会员
								</a>
							</span>
							<div class="btn-group">
								<button class="btn btn-default btn-sm  btn-operation"  type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="<?php echo U('user/deleteuserjia');?>">
									 删除
								</button>
							</div>
						</div>
							...
							<?php foreach( $list as $row ){ ?>
								<tr>
									...
									<td style="cursor: pointer;" >
										<img src="<?php echo tomedia($row['avatar']);?>" style="width:60px;" />
									</td>
									<td ><?php echo ($row['mobile']); ?></td>
									<td>
									
										<a class="layui-btn layui-btn-xs " href="<?php echo U('user/adduserjia', array('id' => $row['id'] , 'ok' => 1));?>">
											<i class="layui-icon layui-icon-edit"></i>编辑
										</a>
						
										<a  class='layui-btn layui-btn-xs deldom' href="javascript:;" data-href="<?php echo U('user/deleteuserjia', array('id' => $row['id']));?>" data-confirm='确认要删除此虚拟会员吗'>
