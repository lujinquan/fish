				...
				<ul class=" layui-col-space12 layui-col-md12 layui-this">
				 ...
				 <ul class=" layui-col-space12 layui-col-md12 layui-this">
                      ...
                      <li class="layui-col-xs25">
                        <a href="javascript:;" class="layadmin-backlog-body">
                          <h3>新增供货商</h3>
                          <p><cite><?php echo ($add_supplier); ?></cite></p>
                        </a>
                      </li>
                      <li class="layui-col-xs25">
                        <a href="javascript:;"  class="layadmin-backlog-body">
                          <h3>新增团长</h3>
                          <p><cite><?php echo ($add_head); ?></cite></p>
                        </a>
                      </li>
					  <li class="layui-col-xs25">
                        <a href="javascript:;"  class="layadmin-backlog-body">
				...
				<div class="layui-col-sm6" style="margin-right:10px;">
					...
					<table class="layui-table layuiadmin-page-table hs" lay-skin="line">
                      ...
                      <tbody>
						...
						<tr>
                          <td><?php echo $i; ?></td>
                          <td><?php echo ($s["community_name"]); ?></td>
                          <td><?php echo ($s["head_name"]); ?></td>
                          <td><?php echo ($s["count"]); ?></td>
                          <td><?php echo ($s["sale_money"]); ?></td>
                        </tr>
						<?php $i++; } ?>
                      </tbody>
                    </table>
