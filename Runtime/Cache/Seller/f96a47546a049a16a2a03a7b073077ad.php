		...
		<div class="layui-card-body" style="padding:15px;padding-bottom:0px;">
			...
			<div>
				...
				<div class="div-inline" style="background: rgb(81, 194, 132);">
					<?php if( empty($zongtuishu)){ ?> <b class="b">0</b> <?php }else{ ?><b class="b"><?php echo ($zongtuishu); ?></b><?php } ?>
				...
				<div class="div-inline" style="background: rgb(80, 164, 254);">
					<?php	 $tuikuan = sprintf("%.2f",$tuikuan); ?>
					<?php if( empty($tuikuan)){ ?> <b class="b">0</b> <?php }else{ ?><b class="b"><?php echo ($tuikuan); ?></b><?php } ?>
				...
				<div class="row">
					<div class="list-div list-tb-div">
						<table cellpadding="0" cellspacing="0" border="0" style="background-color:#fff;">
                             ...
                             <tr>
                               <th class="div-inline2" style="font-size:14px;font-weight:bold;">下单日期</th>
							   <th class="div-inline2" style="font-size:14px;font-weight:bold;">订单数</th>
							   <th class="div-inline2" style="font-size:14px;font-weight:bold;">下单金额</th>
							   <th class="div-inline2" style="font-size:14px;font-weight:bold;">退款笔数</th>
							   <th class="div-inline2" style="font-size:14px;font-weight:bold;">退款金额</th>
							   <th class="div-inline2" style="font-size:14px;font-weight:bold;">取消笔数</th>
							   <th class="div-inline2" style="font-size:14px;font-weight:bold;">取消金额</th>
							   <th class="div-inline2" style="font-size:14px;font-weight:bold;">小计</th>
                             <tr>
						...
						<table cellpadding="0" cellspacing="0" border="0" style="background-color:#fff;">
							...
							<?php foreach($list2 as $k => $w){ ?>	
								<tr>
									...
									<th width="15%" class="div-inline2"><?php echo ($w["daytui"]); ?></th>
									<?php	 $w["daytuikuan"] = sprintf("%.2f",$w["daytuikuan"]); ?>
									<th width="15%" class="div-inline2"><?php echo ($w["daytuikuan"]); ?></th>
