						...
						<div class="layui-form-item">
							...
							<div class="col-sm-3">
								<div class='form-control-static'><?php echo ($member['score']); ?>
									<a class="text-primary ajaxModal" data-href="<?php echo U('user/recharge', array('type'=>'score','id'=>$member['member_id']));?>" style="padding-left: 5px;cursor:pointer;">充值</a>
									<a class="layui-btn layui-btn-xs" href="<?php echo U('user/integral_flow', array('id'=>$member['member_id']));?>"title=''>积分流水</a>
								</div>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="col-sm-3">
								<div class='form-control-static'><?php echo ($member['account_money']); ?>
									<a class="text-primary ajaxModal" data-href="<?php echo U('user/recharge', array('type'=>'account_money','id'=>$member['member_id']));?>" style="padding-left: 5px;cursor:pointer;">充值</a>
								  <a class="layui-btn layui-btn-xs" href="<?php echo U('user/recharge_flow', array('id'=>$member['member_id']));?>"title=''>余额流水</a>
								</div>
							</div>
