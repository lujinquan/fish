                        ...
                        <div class="col-md-12">
                            <div class="page-table-header">
            					...
            					<span class="pull-right">
            						<a href="<?php echo U('delivery/adddelivery_clerk',array('ok'=>1));?>" class="layui-btn layui-btn-sm"><i class="fa fa-plus"></i> 添加配送人员</a>
									
									<a  class='btn layui-btn  layui-btn-sm' id="clerk_allprint" data-href="<?php echo U('delivery/clerk_allprint', array('id' => $item['id'],'ok'=>1));?>" >
										<span data-toggle="tooltip" data-placement="top" title="" data-original-title="打印配送单">
											一键打印配送单
										</span>
									</a>
									
									<a  class='btn layui-btn  layui-btn-sm' style="display:none;" id="clerk_allprint_order"  data-href="<?php echo U('delivery/clerk_allprint_order');?>" >
                                ...
                                <div class="btn-group">
                                    <button class="btn btn-default btn-sm btn-operation" type="button" data-toggle='batch-remove' data-confirm="确认要删除吗，删除后商品将进入回收站?" data-href="<?php echo U('delivery/deldelivery_clerk');?>">
                                    ...
                                    <tr>
                    					...
                    					<td>
                    						<div style="display: flex">
                    						   <img class="img-40" src="<?php echo tomedia($item['logo']);?>" style='border-radius:50%;border:1px solid #efefef;' />
                						...
                						<td  style="overflow:visible;position:relative">
                							<a  class='layui-btn layui-btn-xs' href="<?php echo U('delivery/adddelivery_clerk', array('id' => $item['id'],'ok'=>1));?>" >
                                            ...
                                            <a  class='layui-btn layui-btn-danger layui-btn-xs deldom' href="javascript:;" data-href="<?php echo U('delivery/deldelivery_clerk',array('id' => $item['id']));?>" data-confirm='确认要删除吗?'>
