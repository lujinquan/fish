...
class DeliveryController extends CommonController{
	...
	public function orders_downexcel()
	{
       ...
       //p($exportlists);
		...
		D('Seller/Excel')->export_delivery_all_list($exportlists, array('title' => $delivery_date.'清单数据', 'columns' => $columns , 'sheetsTitleArr' => $sheetsTitleArr ,'sheetsMergeArr' => $sheetsMergeArr ,'sheetsAttrArr' => $sheetsAttrArr,'delivery_date' => $delivery_date));
		die();
	}
