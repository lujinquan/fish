...
class CarController extends CommonController {
	...
	**/
	...
	public function add()
	{
		...
		//$data['community_id']
		if( $data['buy_type'] == 'dan' || ($pintuan_model_buy ==1 && $data['buy_type'] != 'dan') )
		{
			$is_community = D('Seller/Communityhead')->is_community($data['community_id']);
			if( !$is_community )
			{
	...
	//if( $buy_type == 'dan' )
	if( $buy_type == 'dan'  || ($pintuan_model_buy == 1 && $buy_type != 'dan' && $buy_type != 'integral'  ) )			
	{
	...
	if( $buy_type == 'dan' && !empty($man_free_tuanzshipping) && $man_free_tuanzshipping > 0 && $man_free_tuanzshipping <= $store_buy_total_money )
	{
...
public function sub_order()
{
	...
	if( $data_s['buy_type'] == 'dan' || ($pintuan_model_buy == 1 && $data_s['buy_type'] != 'dan' && $data_s['buy_type'] != 'integral'  ) )
	{
